...
function preload() {
	...
	game.load.image('ball', '../../public/images/brickBreaker/ball.png');
	game.load.image('paddle', '../../public/images/brickBreaker/paddle.png');
	game.load.image('brick', '../../public/images/brickBreaker/brick.png');
	game.load.spritesheet('ball', '../../public/images/brickBreaker/wobble.png', 20, 20);
	game.load.spritesheet('button', '../../public/images/brickBreaker/button.png', 120, 40);
}
